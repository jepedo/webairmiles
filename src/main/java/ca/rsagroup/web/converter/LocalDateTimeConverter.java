 ...
 */
package ca.rsagroup.web.converter;
...
public class LocalDateTimeConverter implements Converter, PartialStateHolder {
    ...
    private DateTimeFormatter formatter2 = DateTimeFormat.forPattern(pattern2);
    /**
    ...
    public Object getAsObject(FacesContext pFacesCtx, UIComponent pComponent, String value) {
        ...
        try {
			if(value.length()==16)
				return formatter.parseDateTime(value).toLocalDateTime().toDate();
			else if (value.length()==10){
				return formatter2.parseDateTime(value.substring(0,10)).toLocalDateTime().toDate();
			}
			return null;
		} catch (Exception e) {
